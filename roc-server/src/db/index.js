    ...
    DbQueryInterface.prototype.getRegion = function (regionId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.db.one("SELECT * from region where id = " + regionId)];
            });
        });
    };
    DbQueryInterface.prototype.searchRegions = function (target, fractionation, intent, importance) {
            ...
            return __generator(this, function (_a) {
                ...
                if (fractionation !== null) {
                    if (fractionation.every(function (x) { return typeof x === 'number'; })) {
                        ...
                        whereClause += "AND fractionation.description in ( " + ("'" + fractionation.join("', '") + "'") + " ) ";
                    }
                }
                if (intent !== null) {
